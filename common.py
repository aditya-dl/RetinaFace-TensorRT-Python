...
def find_simple_data(description="Runs a TensorRT Python sample", subfolder="", find_files=[]):
    '''
...
def allocate_buffers_dynamic(engine, context):
    inputs = []
    outputs = []
    bindings = []
    ...
    for i, binding in enumerate(engine):
        size = trt.volume(context.get_binding_shape(i)) * engine.max_batch_size
